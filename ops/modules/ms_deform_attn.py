...
class MSDeformAttn(nn.Module):
    def __init__(self, d_model=768, n_levels=3, n_heads=12, n_points=4):
        """
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index,
        ...
        # input_padding_mask = input_padding_mask.to('cuda:1')
        ...
        # print(input_spatial_shapes.max(), input_spatial_shapes.min())
        # print(input_level_start_index.max(), input_level_start_index.min())
        # print(sampling_locations.max(), sampling_locations.min())
        # print(attention_weights.max(), attention_weights.min())
