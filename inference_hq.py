...
parser.add_argument('-o', '--seg_path_root', type=str, default='./data/test_result/nopre_5+5',
                    help='path to the segmentation folder')
parser.add_argument('--seg_png_path', type=str, default='./data/test_result/sanity_test/nopre_5+5',
                    help='path to the segmentation folder')
parser.add_argument('--model_type', type=str, default='vit_b', help='model type')
parser.add_argument('--device', type=str, default='cuda:1', help='device')
parser.add_argument('-chk', '--checkpoint', type=str, default='./work_dir/train_nopre_5+5/sam_model_no_pre4.pth',
