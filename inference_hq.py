...
parser.add_argument('-o', '--seg_path_root', type=str, default='./data/test_result/detr-Msc4-2+3',
                    help='path to the segmentation folder')
parser.add_argument('--seg_png_path', type=str, default='./data/test_result/sanity_test/detr-Msc4-2+3',
                    help='path to the segmentation folder')
parser.add_argument('--model_type', type=str, default='vit_b', help='model type')
parser.add_argument('--device', type=str, default='cuda:0', help='device')
parser.add_argument('-chk', '--checkpoint', type=str, default='work_dir/detr-Msc4-2+n/sam_model_no_pre2.pth',
