...
def finetune_model_predict(img_np, box_np, sam_trans, sam_model_tune, device):
    ...
    with torch.no_grad():
        ...
        medsam_model.load_state_dict(torch.load("work_dir/MASK-Two/sam_model_no_pre14.pth"))
...
parser.add_argument('-o', '--seg_path_root', type=str, default='./data/test_result/MASK-Two-15',
                    help='path to the segmentation folder')
parser.add_argument('--seg_png_path', type=str, default='./data/test_result/sanity_test/MASK-Two-15',
                    help='path to the segmentation folder')
parser.add_argument('--model_type', type=str, default='vit_b', help='model type')
parser.add_argument('--device', type=str, default='cuda:0', required=True, help='device')
parser.add_argument('-chk', '--checkpoint', type=str, default='work_dir/MASK-Two/sam_model_no_pre14.pth',
