...
def finetune_model_predict(img_np, box_np, sam_trans, sam_model_tune, device='cuda:0'):
    ...
    with torch.no_grad():
        ...
        medsam_model.load_state_dict(torch.load("work_dir/MASK/sam_model_no_pre2.pth"))
...
parser.add_argument('-o', '--seg_path_root', type=str, default='./data/test_result/CT-2',
                    help='path to the segmentation folder')
parser.add_argument('--seg_png_path', type=str, default='./data/test_result/sanity_test/CT-2',
                    help='path to the segmentation folder')
parser.add_argument('--model_type', type=str, default='vit_b', help='model type')
parser.add_argument('--device', type=str, default='cuda:0', help='device')
parser.add_argument('-chk', '--checkpoint', type=str, default='work_dir/MASK/sam_model_no_pre2.pth',
